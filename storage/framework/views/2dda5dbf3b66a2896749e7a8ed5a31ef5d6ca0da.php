...
<?php $__env->startSection('content'); ?>
	...
	<div class="section">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<h3><i class="fa fa-info-circle"></i> <?php echo e($lienHe[0]->title_lienhe); ?></h3>
						    
	                <div class="break"></div>
				   	<h4><i class= "fa fa-home"></i> Địa chỉ: <small><?php echo e($lienHe[0]->diachi); ?></small></h4>

	                <h4><i class="fa fa-envelope"></i> Email : <small><?php echo e($lienHe[0]->email); ?></small></h4>

	                <h4><i class="fa fa-phone"></i> Điện thoại: <small><?php echo e($lienHe[0]->phone); ?></small></h4>
