            ...
            <ul class="nav navbar-nav">
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="/public/upload/users/<?php echo e($currentAdmin->avatar); ?>" class="user-image" alt="User Image">
                        <span class="hidden-xs"><?php echo e($currentAdmin->name); ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <li class="user-header">
                            <img src="/public/upload/users/<?php echo e($currentAdmin->avatar); ?>" class="img-circle" alt="User Image">
                            <p>
    ...
    <section class="sidebar">
        <div class="user-panel">
            ...
            <div class="pull-left info">
                <p><?php echo e($currentAdmin->name); ?></p>
