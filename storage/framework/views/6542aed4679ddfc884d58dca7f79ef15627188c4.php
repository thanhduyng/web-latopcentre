	...
	<div class="content-wrapper">
	    ...
	    <section class="content container-fluid">
			...
			<div class="box box-primary">
                ...
                <?php endif; ?>
			    <!-- form start -->
			    <form role="form" method="POST" enctype="multipart/form-data" action="admin/slide/sua/<?php echo e($slide->id); ?>">
			    	<input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
			        <div class="box-body">
			            <div class="form-group">
			                <label for="txtLink">Liên kết</label>
			                <input type="text" class="form-control" id="txtLink" name="txtLink" placeholder="Nhập liên kết" required="" value="<?php echo e($slide->link); ?>">
			            </div>

			            <div class="form-group">
			                <label for="filImage">Hình ảnh</label>
			                <img src="../upload/slide/<?php echo e($slide->image); ?>" width="300px">
